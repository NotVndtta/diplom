...
module Form
  class CheckboxGroup < ApplicationForm
    sig do
      void.params(
    ...
    sig { returns(String) }
    def call
      render(Form::Group.new(classes: @classes, label_position: :left, show_all_errors: @show_all_errors, errors:)) do
        concat(render(Form::Checkbox.new(@form_object, @object_name, @input_html)))
