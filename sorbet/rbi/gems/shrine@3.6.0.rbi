...
module Shrine::Attacher::InstanceMethods
  ...
  #     #=> #<Shrine::UploadedFile>
  #
  # source://shrine//lib/shrine/attacher.rb#361
  ...
  # @return [Boolean]
  #
  # source://shrine//lib/shrine/attacher.rb#384
  def change?(file); end
  ...
  # @return [Boolean]
  #
  # source://shrine//lib/shrine/attacher.rb#374
  def promote?; end
  ...
  # @return [Boolean]
  #
  # source://shrine//lib/shrine/attacher.rb#389
...
module Shrine::UploadedFile::InstanceMethods
  ...
  #
  # source://shrine//lib/shrine/uploaded_file.rb#226
  def ==(other); end
  ...
  #
  # source://shrine//lib/shrine/uploaded_file.rb#215
  ...
  #
  # source://shrine//lib/shrine/uploaded_file.rb#220
  def data; end

  # Calls `#delete` on the storage, which deletes the file from the
  # storage.
  #
  # source://shrine//lib/shrine/uploaded_file.rb#199
  def delete; end
  ...
  # @return [Boolean]
  #
  # source://shrine//lib/shrine/uploaded_file.rb#188
  def exists?; end
  ...
  #
  # source://shrine//lib/shrine/uploaded_file.rb#234
  def hash; end
  ...
  #
  # source://shrine//lib/shrine/uploaded_file.rb#254
  def inspect; end
  ...
  # @return [Boolean]
  #
  # source://shrine//lib/shrine/uploaded_file.rb#177
  def opened?; end
  ...
  #
  # source://shrine//lib/shrine/uploaded_file.rb#193
  ...
  #
  # source://shrine//lib/shrine/uploaded_file.rb#249
  def shrine_class; end
  ...
  #
  # source://shrine//lib/shrine/uploaded_file.rb#244
  def storage; end
